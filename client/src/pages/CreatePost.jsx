  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">Generate an imaginative and visually stunning image through DALL-E AI and share it with the community</p>
      </div>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            <div className="mt-5 flex gap-5">
              ...
              >
                {generatingImg ? 'Generating...' : 'Generate from Text'}
              </button>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <button type="button" className=" text-red bg-slate-300 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center" 
            onClick={resetTranscript}>Reset</button>
          </div>
            <div>
              <button
                type="button"
                onClick={generatevImage}
                className=" text-white bg-green-700  font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
              >
                {generatingImg ? 'Generating...' : 'Generate using Voice'}
              </button>
            </div>
